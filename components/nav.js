      ...
      <div id="sidebar-section">
        <nav id="sidebar">
              ...
              <div id="plans-side-logo">
                <Link href="/plans"><Image className="plans" src="/images/PlansIcon.png" width={30} height={30}/></Link>
              </div>
              ...
              <div id="settings-side-logo">
                <Link href="/settings"><Image className="settings" src="/images/settings.png" width={30} height={30}/></Link>
              </div>
              </nav>
      </div>
      );
