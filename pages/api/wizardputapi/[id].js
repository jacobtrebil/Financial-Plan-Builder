    ...
    switch (method) {
        case 'PUT':
            try {
                ...
                await Plan.updateOne({ _id: id}, { pension, pensionStartAge, pensionEarnings, pensionInflation, retirementAge, retirementIncome, livingExpense, assetValue, currentEarnings, currentSavings })
