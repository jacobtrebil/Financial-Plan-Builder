...
export default function calculateTotalRetirementEarnings(age) {
    /*let i = Object.values(age);
    let totalRetirementEarnings = z.reduce((a, b) => a + b); */



    /* let i = Object.values.numbers(age)
    console.log(i);
    let totalRetirementEarnings =+ Math.floor(age[i]); */
    ...
    /* let totalRetirementEarnings = 0;
    for ( var i in age ) {
        if ( age.hasOwnProperty( i )) {
            totalRetirementEarnings += parseInt( age[i] );
        }
    }; 
